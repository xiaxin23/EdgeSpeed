...
class LoRA_ViT_timm(nn.Module):
    ...
    def forward(self, x: Tensor, starting_id: int = 0, return_interval: bool = False) -> Union[torch.Tensor, List[torch.Tensor]]:
        return self.lora_vit(x, starting_id, return_interval)
